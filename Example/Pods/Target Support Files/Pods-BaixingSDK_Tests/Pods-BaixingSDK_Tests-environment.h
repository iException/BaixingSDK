...
// BaixingSDK
#define COCOAPODS_POD_AVAILABLE_BaixingSDK
#define COCOAPODS_VERSION_MAJOR_BaixingSDK 0
#define COCOAPODS_VERSION_MINOR_BaixingSDK 1
#define COCOAPODS_VERSION_PATCH_BaixingSDK 0
